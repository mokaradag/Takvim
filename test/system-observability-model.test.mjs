...
test('ölçülemeyen kural temiz gözlem sayılmaz', (t) => {
  ...
  t.after(resetAlertTrackerForTests);
  const condition = [{
    key: alertKey(COMPONENTS.API, 'API_ERROR_RATE_HIGH'),
  ...
  assert.ok(unmeasured.has(alertKey(COMPONENTS.API, 'API_ERROR_RATE_HIGH')));
  ...
  assert.deepEqual(
    ...
    [alertKey(COMPONENTS.API, 'API_ERROR_RATE_HIGH')]
  );
});
