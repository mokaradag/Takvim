...
const STATE_ICON = {
  ...
  // Kritik ile dikkat AYRI simgelerle gösterilir; yalnızca renk farkı, renk
  // ayrımı olmayan bir kullanıcı için iki durumu aynı yapardı.
  [HEALTH_STATES.CRITICAL]: Icons.Critical,
