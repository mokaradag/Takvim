          ...
          <section className="card reminder-section">
            ...
            {history.length === 0 ? (
              ...
              <div className="reminder-history-scroll">
                {/* Tabloya ERİŞİLEBİLİR AD verilir: tablo tablo gezen ekran
                    okuyucu kullanıcısı bunun "Son gönderimler" olduğunu
                    görünür başlığa bakmadan anlayamazdı. */}
                <table className="tbl" aria-label="Son gönderimler">
                  <thead>
