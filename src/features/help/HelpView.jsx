...
const CONTENT = {
  ...
  kanban: {
    ...
    points: ['Görev, proje, sorumlu veya etiket arayın; Direktörlük → Müdürlük → Birim süzgeçleriyle daraltın.', 'Görevler ve Kanban aynı kurumsal seçimi paylaşır; Filtreleri temizle seçimi sıfırlar.', 'Görevleri durum kolonlarında izleyin.', 'Kartlara tıklayarak görev ayrıntılarını açın.', 'Proje seçimi değiştiğinde pano otomatik olarak seçili projenin görevlerine geçer.']
  },
  rapor: {
    title: 'Raporlar',
