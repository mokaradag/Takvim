...
import { APP_FAVICON_DATA_URI } from '../lib/appFavicon.js';
  ...
  return (
    <html lang="tr">
      <head>
        ...
        {/* SVG desteklemeyen eski istemciler aynı veri URI'sini genel simge
            olarak da alır; ek dosya ve ağ isteği doğurmaz. */}
