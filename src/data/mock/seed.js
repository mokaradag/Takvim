import { normalizeProjectReferences } from '../../domain/validation/index.js';
...
const RAW_PROJECTS = [
  { id: 'p-web', name: 'Web Sitesi Yenileme', color: 'blue', lead: 'Ahmet Yılmaz', calendarId: 'cal-tr-standard-2026', dataDate: MOCK_DATA_DATE },
  { id: 'p-mobile', name: 'Mobil Uygulama', color: 'purple', lead: 'Mehmet Demir', calendarId: 'cal-tr-standard-2026', dataDate: MOCK_DATA_DATE },
  { id: 'p-social', name: 'Sosyal Medya', color: 'rose', lead: 'Ayşe Kaya', calendarId: 'cal-tr-standard-2026', dataDate: MOCK_DATA_DATE },
  { id: 'p-db', name: 'Veritabanı Göçü', color: 'amber', lead: 'Can Özkan', calendarId: 'cal-tr-standard-2026', dataDate: MOCK_DATA_DATE },
  { id: 'p-infra', name: 'Altyapı', color: 'cyan', lead: 'Can Özkan', calendarId: 'cal-tr-operations-2026', dataDate: MOCK_DATA_DATE },
  { id: 'p-brand', name: 'Marka Kimliği', color: 'emerald', lead: 'Elif Yıldız', calendarId: 'cal-tr-standard-2026', dataDate: MOCK_DATA_DATE }
];
