 ...
 *
 * `LastFailureCode` TEMİZLENİR: kayıt yeniden kuyruğa alınmıştır. Kod yerinde
 * kalsaydı kuyruk durumu onu hâlâ "başarısız" sayar ve bir sonraki yeniden
 * deneme aynı satırı tekrar seçerdi.
 */
