...
import { mergeTweakPreferences, TWEAK_DEFAULTS } from './tweaks-defaults.js';
...
export function bodyClassesForTweaks(tweaks = {}) {
  tweaks = mergeTweakPreferences(TWEAK_DEFAULTS, tweaks);
...
t=(${mergeTweakPreferences.toString()})(t,p);
}catch(e){}
