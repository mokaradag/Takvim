    ...
    <div className={`app app-mode-${simpleMode ? 'simple' : 'advanced'} sidebar-is-${sidebarPinned ? 'pinned' : 'unpinned'} sidebar-is-${sidebarCollapsed ? 'collapsed' : 'expanded'}`} data-view={view}>
      ...
      <div className="main">
        ...
        <TaskOrganizationFilterProvider>
          {/* GENEL sayfalar çalışma alanı anahtarına bağlanmaz: proje ya da kip
              değişimi Sistem Yönetimi'ni yeniden bağlayıp açık sekmeyi, çekmeceyi
              ve süren isteği düşürürdü. */}
          <main
            key={globalPage ? `global:${view}` : workspaceKey}
            className={contentClassName(view, { calendarActive: calendarContentActive })}
          >
            {renderView()}
          </main>
        </TaskOrganizationFilterProvider>
